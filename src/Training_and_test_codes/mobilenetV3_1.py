...
history = model.fit(
    ...
    epochs=EPOCHS,
    callbacks=[EarlyStopping(patience=5, restore_best_weights=True), LearningRateLogger()], # Increased patience
...
# === Save ===
SAVE_PATH = "/mnt/shared/College_work_data/Data_sets/CP_MODEL/MNV3_PHASE1_F1.h5"
