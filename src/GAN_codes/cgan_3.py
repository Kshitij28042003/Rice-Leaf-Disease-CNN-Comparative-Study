...
CHANNELS = 3
LATENT_DIM = 128
BATCH_SIZE = 32 # Kept at 32 to avoid memory errors.

# --- Training Parameters ---
# ✅ Set to True to load the previous models and continue training.
CONTINUE_TRAINING = True
# ✅ Train for 200 additional epochs.
EPOCHS = 200
...
CHECKPOINT_DIR = os.path.join(OUTPUT_DIR, "checkpoints") # Folder for checkpoints.
if not os.path.exists(CHECKPOINT_DIR):
    os.makedirs(CHECKPOINT_DIR)

# Define paths for both models.
GENERATOR_SAVE_PATH = os.path.join(OUTPUT_DIR, "cgan_generator.h5")
DISCRIMINATOR_SAVE_PATH = os.path.join(OUTPUT_DIR, "cgan_discriminator.h5")
...
def load_dataset():
    ...
    for idx, class_name in enumerate(CLASSES):
        class_folder = os.path.join(BASE_PATH, class_name, "og")
...
# =================================================================================
# SECTION 3: CONDITIONAL GAN (CGAN) MODEL ARCHITECTURE (No Changes)
# =================================================================================
def build_generator():
...
# =================================================================================
# SECTION 4: LOAD OR BUILD MODELS
# =================================================================================
# This logic handles loading existing models or building new ones.

# --- Generator ---
if CONTINUE_TRAINING and os.path.exists(GENERATOR_SAVE_PATH):
    print(f"▶️ Loading existing generator from: {GENERATOR_SAVE_PATH}")
    generator = tf.keras.models.load_model(GENERATOR_SAVE_PATH)
    print("✅ Generator loaded successfully.")
else:
    print("▶️ Building new generator from scratch...")
    generator = build_generator()
    print("✅ New generator built.")

# --- Discriminator ---
if CONTINUE_TRAINING and os.path.exists(DISCRIMINATOR_SAVE_PATH):
    print(f"▶️ Loading existing discriminator from: {DISCRIMINATOR_SAVE_PATH}")
    discriminator = tf.keras.models.load_model(DISCRIMINATOR_SAVE_PATH)
    print("✅ Discriminator loaded successfully.")
else:
    print("▶️ Building new discriminator from scratch...")
    discriminator = build_discriminator()
    print("✅ New discriminator built.")
...
# =================================================================================
# SECTION 5: TRAINING LOOP (No Changes)
# =================================================================================
...
print(f"▶️ Starting training for {EPOCHS} additional epochs...")
for epoch in range(EPOCHS):
    ...
    # Save a sample image grid every 5 epochs
    if (epoch + 1) % 5 == 0:
        save_sample_images(epoch + 1)
        
    # Save a checkpoint of the models periodically.
...
# =================================================================================
# SECTION 6: SAVE THE FINAL MODELS
# =================================================================================
