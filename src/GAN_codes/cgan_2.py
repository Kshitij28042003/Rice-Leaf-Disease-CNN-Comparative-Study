...
# =================================================================================
if CONTINUE_TRAINING and os.path.exists(GENERATOR_SAVE_PATH): #and os.path.exists(DISCRIMINATOR_SAVE_PATH):
    print("▶️ Loading existing models to continue training...")
    ...
    print("▶️ Building new models from scratch...")
...
# ✅ Save the discriminator as well so you can continue the session later.
