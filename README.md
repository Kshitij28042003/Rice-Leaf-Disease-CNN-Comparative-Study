...
│
├── data/                          # Dataset (sample images only)
│   ├── Blast/
│   ├── Blight/
│   ├── Brownspot/
│   └── Healthy/
...
│
├── results/                       # Experimental results & graphs
...
│
├── src/                           # Source code
│   ├── GAN_codes/                 # WGAN-GP & augmentation
│   │   ├── cgan.py
│   │   ├── cgan_blast.py
│   │   ├── cgan_blight.py
│   │   └── cgan_brownspot.py
│   │
│   └── Training_and_test_codes/   # CNN training scripts
│       ├── R101_1.py              # ResNet101
│       ├── R50_1.py               # ResNet50
│       ├── DN121_1.py             # DenseNet121
│       ├── EN_1.py                # EfficientNet
│       ├── Xception_1.py
│       ├── VGG16_SKF_1.py
│       ├── mobilenetV3_1.py
│       └── Test_final.py
